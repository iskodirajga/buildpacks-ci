...
create_instance_output = `aws ec2 run-instances --image-id #{ami_image_id} --subnet-id subnet-106cd948 --instance-type c3.4xlarge --associate-public-ip-address`
...
puts "Instance #{new_instance_id} created, waiting for status: OK"

system "aws ec2 wait system-status-ok --instance-ids #{new_instance_id}"
